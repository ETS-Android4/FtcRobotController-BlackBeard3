...
public class RedAutonomous extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        controller.left(DRIVE_POWER, controller.cmToTicksSide(36)); //drive left to get to the target
        carousel2.setPower(1);
        controller.runMotorForTime(carousel, CAROUSEL_POWER, 4000); //spin the carousel to drop the duck
        ...
        controller.forward(1, controller.cmToTicks(300)); //drive forward
