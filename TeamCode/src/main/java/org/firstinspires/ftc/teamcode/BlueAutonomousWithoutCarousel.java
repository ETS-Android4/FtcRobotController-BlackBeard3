...
@Autonomous
public class BlueAutonomousWithoutCarousel extends LinearOpMode {
...
//        controller.backward(DRIVE_POWER, controller.cmToTicks(100));
        ...
        //carousel mission
        //controller.rotationLeft(DRIVE_POWER, controller.cmToTicks(18));
        //controller.right(DRIVE_POWER, controller.cmToTicksSide(60)); //drive left to get to the target
