...
@Autonomous
public class RedAutonomousWithoutCarousel extends LinearOpMode {
...
//        controller.backward(DRIVE_POWER, controller.cmToTicks(100));
        ...
        //carousel mission
//        controller.rotationRight(DRIVE_POWER, controller.cmToTicks(18));
//        controller.left(DRIVE_POWER, controller.cmToTicksSide(60)); //drive left to get to the target
//        carousel2.setPower(1);
//        controller.runMotorForTime(carousel, C[AROUSEL_POWER, 5000); //spin the carousel to drop the duck
//        carousel2.setPower(0);
        controller.forward(DRIVE_POWER, controller.cmToTicks(90)); //drive forward
        controller.rotationRight(DRIVE_POWER, controller.cmToTicks(60)); //TURN right
        controller.forward(1, controller.cmToTicks(250)); //drive forward
